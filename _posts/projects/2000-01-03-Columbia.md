...
description: A home page redesign integrating user localizatin for hurricane risk communication.
categories: projects
layout: project-post
...
<div class="project">
	<div class="header">
		<img src="/assets/images/projects/columbia/project-post/01.png" />
		<div class="info">
			Project
			Risk Communication
			...
			Roles
			UX Design, Research, and UI Design
		</div>
	</div>
